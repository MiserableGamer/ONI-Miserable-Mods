...
namespace ControlledAutomation.UI
{
    public class TemperatureRangeSideScreen : SideScreenContent, IRender200ms
    {
        ...
        public override void OnPrefabInit()
        {
            ...
            // Invert checkbox (wrapped in left-aligned panel to match other sidescreen checkboxes)
            var invertCheckboxPanel = new PPanel("InvertCheckboxPanel")
            {
                Direction = PanelDirection.Horizontal,
                Spacing = SideScreenLayout.CheckboxPanelSpacing,
                FlexSize = Vector2.right,
                Alignment = TextAnchor.MiddleLeft,
                Margin = SideScreenLayout.CheckboxRowMargin
            };
            ...
            invertCheckboxPanel.AddChild(invertCheckbox);
            mainPanel.AddChild(invertCheckboxPanel);
