...
- **Capacity Control** - Increase character limit in capacity input fields. Support for larger storage values.
...
Access mod options through the Mods menu (gear icon) to customize all features.

## Compatibility

- **Oxygen Not Included** - Build 642695 or later
- **DLC Support** - Works with base game, Spaced Out!, and Frosty Planet Pack
