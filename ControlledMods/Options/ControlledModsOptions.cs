...
namespace ControlledMods.Options
{
    ...
    public sealed class ControlledModsOptions
    {
        ...
        [Option("Enable channel filter in sidescreen",
            "When enabled, adds a text input above the channel list so you can type to filter channels (e.g. type 'lime' to show only matching channels). " +
            "Requires KIN Underground Conduit mod.",
            "KIN Underground Conduit")]
        [JsonProperty]
        public bool EnableChannelFilter { get; set; } = true;
