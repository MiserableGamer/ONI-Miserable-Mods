[h1]Controlled Buildings[/h1]

Adjusts building footprints and placement rules to fix visual conflicts with decorative elements like ceiling trim.

[h2]Features[/h2]
[list]
[*][b]Juicer Footprint Fix[/b] - Reduces the Juicer's placement footprint from 3x4 to 3x3, so it fits in 4-high rooms with ceiling trim along the top row. The building retains its full visual appearance.
[*][b]Transit Tubes & Backwall[/b] - Transit tubes always draw in front of drywall/backwall, and drywall can be built in the same cell as tubes. Tube segments can be built in or behind tiles. Tighter bends and connection rules are allowed.
[/list]

[h2]How to Use[/h2]
[olist]
[*][b]Install the mod[/b] - Subscribe on Steam Workshop or install manually
[*][b]Play normally[/b] - The Juicer will now fit in rooms with ceiling trim without removing 3 tiles of trim
[/olist]
...
[list]
[*][b]One-time patch[/b] - Runs once during game load, no per-frame overhead
[/list]
...
[list]
[*][b]1.0.2[/b]: Fixed atmosphere gas appearing behind drywall
