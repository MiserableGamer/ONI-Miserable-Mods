...
{
    internal const string OldConfigFolderName = "ControlledExtraction.dll";
    internal const string NewConfigFolderName = "ControlledExtraction";
    internal const string ConfigFileName = "ControlledExtraction.json";
