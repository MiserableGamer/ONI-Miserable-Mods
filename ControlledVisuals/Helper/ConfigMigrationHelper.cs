...
namespace ControlledVisuals.Helper
{
    ...
    {
        internal const string OldConfigFolderName = "ControlledVisuals.dll";
        internal const string NewConfigFolderName = "ControlledVisuals";
