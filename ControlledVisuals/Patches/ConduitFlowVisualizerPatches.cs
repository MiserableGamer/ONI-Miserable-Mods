...
namespace ControlledVisuals.Patches
{
    ...
    public static class ConduitFlowVisualizerPatches
    {
        ...
        {
            var quality = CVOptions.Instance.ConduitAnimation;
            ReduceFlowUpdates = quality != CVOptions.ConduitAnimationQuality.Full;
        ...
        internal static void Init()
        {
            ...
            switch (quality)
            {
                case CVOptions.ConduitAnimationQuality.Reduced:
                    updateRate = UPDATE_RATE_REDUCED;
                    break;
                case CVOptions.ConduitAnimationQuality.Minimal:
                    updateRate = UPDATE_RATE_MINIMAL;
                    break;
                case CVOptions.ConduitAnimationQuality.Full:
                default:
                    updateRate = 0.0;
                    break;
            }
