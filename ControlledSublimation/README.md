...
Subscribe on [Steam Workshop](https://steamcommunity.com/sharedfiles/filedetails/?id=3636578165) and enable in the Mods menu.
...
### 1.1.0
- Added Bleach Stone Sconce

### 1.0.1
- Initial release with per-element debris/storage control
